 ...
 *******************************************************************************
 * Useful stuff for handling Siemens PDU elements. This collects common methods
 * for parsing or command creation. You may also want to consider the 'Hex'
 * class in org.apache.commons.codec.*. Pretty sure this exists in Guava
 * too.
 *
 * 2002.08.13 - Finished
...
public class ByteCoding {
	...
	static {
		...
		}
		{
			...
			hexLookupStringToByte = new HashMap();
			for (int i = 0; i < 256; i++) {
