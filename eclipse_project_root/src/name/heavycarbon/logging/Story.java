...
import name.heavycarbon.logging.storyhelpers.AsIsString;
import name.heavycarbon.logging.storyhelpers.ConcatMe;
import name.heavycarbon.logging.storyhelpers.Dedent;
import name.heavycarbon.logging.storyhelpers.Doublet;
import name.heavycarbon.logging.storyhelpers.Indent;
 ...
 * 2014.01.16 - Added headerize() and the prepend() methods. Methods taking
 *              "AsIsString" now deprecated.              
 ******************************************************************************/
...
public class Story {
    ...
    /**
     * Canonical indent. In order to permit chaining, "this" is returned after addition.
     */ 
     
    public Story indent() {
        return add(Indent.CI);
    }
    ...
    /**
     * Canonical dedent. In order to permit chaining, "this" is returned after addition.
     */ 
     
    public Story dedent() {
        return add(Dedent.CI);
    }
    ...
    /**
     * Prepending. Passing (null) reduces to a NOP. In order to permit chaining, "this" is returned after addition. 
     */

    public Story prepend(Doublet doublet) {
        return add(0, doublet);       
    }
    ...
    public Story prepend(Indent indent) {
        return add(0, indent);       
    }
    ...
    public Story prepend(Dedent dedent) {
        return add(0, dedent);     
    }
    ...
    public Story prepend(String rawString) {
        return add(0, rawString);
    }
    ...
    public Story prepend(Story story) {
        return add(0, story);
    }
    
    /**
     * An alias for "add". Passing (null) reduces to a NOP. This allows one to write "story << x" in Groovy 
     */

    public Story leftShift(Doublet doublet) {
        return add(doublet);
    }
    ...
    public Story leftShift(Indent indent) {
        return add(indent);       
    }
    ...
    public Story leftShift(Dedent dedent) {
        return add(dedent);     
    }
    ...
    public Story leftShift(String rawString) {
        return add(rawString);
    }
    ...
    public Story leftShift(Story story) {
        return add(story);
    }
    ...
    /**
     * Add a heading String an indent the existing Story. Returns "this" for chaining.
     */
    
    public Story headerize(String header) {
        prepend(Indent.CI);        
        add(Dedent.CI);
        prepend(header);
        return this;
